...
class FindUsingMaxByTest < Minitest::Test
  ...
  def test_array_with_the_fewest_items
    ...
    smallest_array = arrays.max_by { |array| - array.length }
  ...
  def test_most_programmers
    ...
    most_programmers = programmers.max_by { |program| program[1].length }
  ...
  def test_fewest_programmers
    ...
    fewest_programmers = programmers.max_by { |program| -program[1].length }
